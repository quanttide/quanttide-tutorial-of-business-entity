...
先整体读一遍候选人的产出，感受一下——被打动了吗？逻辑清晰吗？有哪个地方让你觉得"这个想法有意思"？有了第一印象之后，再逐项打分。

关注决策逻辑，而非结论。他的方案和你预期不一样，不等于他错了。如果逻辑自洽、假设清晰，即使结论不同，也是合格甚至优秀的。

| 等级 | 市场序列 | 技术序列 |
|------|---------|---------|
| S | 改写稿可直接发布 | 三题出色，模型干净可扩展 |
| A | 质量好，有决策逻辑 | 前两题出色，合理有取舍 |
| B | 方向对但落地偏差 | 能识别问题但模型粗糙 |
| C | 和原文几乎一样或纯广告 | 不理解为何要抽象 |

## 说到底是为什么

传统考核考的是"他会不会"。

我们考的是"他来了能不能用我们的方式解决新问题"。

题目是载体，不是目的。评分标准不是对不对，而是他做选择的时候，脑子里的逻辑是什么。
